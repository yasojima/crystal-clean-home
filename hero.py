...
def publish_hero(root):
    ...
    for device, media in [('desktop', '(min-width:993px)'), ('mobile', '(max-width:992px)')]:
        tags += f'<link rel="stylesheet" href="/crystal-clean-home/brand/hero/{device}.css?v=4" media="{media}" data-home-hero="{device}">\n'
    for asset in ['vendor/lenis.min.js', 'vendor/gsap.min.js', 'vendor/scrolltrigger.min.js', 'script.js']:
        tags += f'<script defer src="/crystal-clean-home/brand/hero/{asset}?v=4" data-home-hero="script"></script>\n'
