...
function totals(cart,map){return cart.reduce((r,l)=>{const v=map.get(l.id);if(!v)return r;r.total+=(v.price||0)*l.qty;r.lines++;if(v.price===null)r.quote=true;return r},{total:0,lines:0,quote:false})}
const api={index,clean,totals};root.CCHCart=api;if(typeof module!=='undefined')module.exports=api;
