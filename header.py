...
def publish_header(root):
    ...
    for name in ('style.css', 'desktop.css', 'mobile.css', 'script.js', 'typography.css', 'section-triangles.svg', 'category-cards.css', 'backgrounds.css', 'crystal-background.webp', 'contact-cta.svg', 'payment-visa.svg', 'payment-mastercard.svg', 'floating.css', 'floating.js', 'bottom-bar.css', 'osouji-menu.css', 'k-icons.svg', 'cart-mark.svg'):
    ...
    def update(path):
        ...
        tags = '<link rel="stylesheet" href="/crystal-clean-home/brand/header/style.css?v=20260923-bar-final2" data-shared-header="style">\n<link rel="stylesheet" href="/crystal-clean-home/brand/header/desktop.css?v=1" media="(min-width:993px)" data-shared-header="desktop">\n<link rel="stylesheet" href="/crystal-clean-home/brand/header/mobile.css?v=1" media="(max-width:992px)" data-shared-header="mobile">\n<script defer src="/crystal-clean-home/brand/header/script.js?v=1" data-shared-header="script"></script><script defer src="/crystal-clean-home/brand/header/floating.js?v=cart-dismiss2" data-shared-header="floating"></script>\n'
